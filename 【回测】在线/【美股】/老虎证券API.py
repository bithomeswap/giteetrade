# pip3 install tigeropen#安装
# pip3 install tigeropen --upgrade#升级
...
#配置参数【这里应该是配置的老虎证券API密钥对中的私钥】
PRIVATE_KEY_PATH = r"C:\Users\13480\Desktop\quant\【回测】在线\【美股】\老虎证券密钥.pem"#密钥地址
TIGER_ID = "20150001"#老虎ID
ACCOUNT = "12345678"#账号
# 持仓股票个数
HOLDING_NUM = 5
# 订单检查次数
...
client_config = get_client_config(
    private_key_path=PRIVATE_KEY_PATH,#配置私钥的路径
    tiger_id=TIGER_ID,
    account=ACCOUNT)
