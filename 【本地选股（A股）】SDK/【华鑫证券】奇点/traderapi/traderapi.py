...
class CTORATstpReqUserLoginField(object):
	...
	# 网关内网IP地址
    GwInnerIPAddress = property(_traderapi.CTORATstpReqUserLoginField_GwInnerIPAddress_get, _traderapi.CTORATstpReqUserLoginField_GwInnerIPAddress_set)

	# 网关外网IP地址
    GwOuterIPAddress = property(_traderapi.CTORATstpReqUserLoginField_GwOuterIPAddress_get, _traderapi.CTORATstpReqUserLoginField_GwOuterIPAddress_set)

	# 网关Mac地址
    GwMacAddress = property(_traderapi.CTORATstpReqUserLoginField_GwMacAddress_get, _traderapi.CTORATstpReqUserLoginField_GwMacAddress_set)
...
# 代理秘钥
TORA_TSTP_AM_AgentKey = cvar.TORA_TSTP_AM_AgentKey
# 简体中文
...
# 沪港通港股主板
TORA_TSTP_PID_SSEHKMain = cvar.TORA_TSTP_PID_SSEHKMain
# 沪港通港股创业板
TORA_TSTP_PID_SSEHKGEM = cvar.TORA_TSTP_PID_SSEHKGEM
# 沪港通港股扩充交易证券
TORA_TSTP_PID_SSEHKETS = cvar.TORA_TSTP_PID_SSEHKETS
# 沪港通港股NasdaqAMX市场
TORA_TSTP_PID_SSEHKNasdaqAMX = cvar.TORA_TSTP_PID_SSEHKNasdaqAMX
# 通用(内部使用)
...
# 上海科创板可交换债
TORA_TSTP_STP_SHKCExchangeableBond = cvar.TORA_TSTP_STP_SHKCExchangeableBond
# 沪港通港股债券
TORA_TSTP_STP_SSEHKBond = cvar.TORA_TSTP_STP_SSEHKBond
# 沪港通港股一篮子权证
TORA_TSTP_STP_SSEHKBasketWarrant = cvar.TORA_TSTP_STP_SSEHKBasketWarrant
# 沪港通港股股本
TORA_TSTP_STP_SSEHKEquity = cvar.TORA_TSTP_STP_SSEHKEquity
# 沪港通港股信托
TORA_TSTP_STP_SSEHKTrust = cvar.TORA_TSTP_STP_SSEHKTrust
# 沪港通港股权证
TORA_TSTP_STP_SSEHKWarrant = cvar.TORA_TSTP_STP_SSEHKWarrant
# 手
...
# 港股通
TORA_TSTP_SPLT_HK = cvar.TORA_TSTP_SPLT_HK
# 科创板
...
# 主板交易
TORA_TSTP_SPLT_Main = cvar.TORA_TSTP_SPLT_Main
# 退市整理版可转债
TORA_TSTP_SPLT_DelConvertBond = cvar.TORA_TSTP_SPLT_DelConvertBond
# 普通申赎
...
# ETF成交
TORA_TSTP_TRT_ETF = cvar.TORA_TSTP_TRT_ETF
# 成分券成交
TORA_TSTP_TRT_Basket = cvar.TORA_TSTP_TRT_Basket
# 资金替代成交
TORA_TSTP_TRT_CashSubs = cvar.TORA_TSTP_TRT_CashSubs
# 交收成交
TORA_TSTP_TRT_Delivery = cvar.TORA_TSTP_TRT_Delivery
# 冲正
TORA_TSTP_TRT_Repeal = cvar.TORA_TSTP_TRT_Repeal
# TCP模式
...
# sf网卡tcpdirect模式-TCP
TORA_TSTP_TCM_TCPDIRECT = cvar.TORA_TSTP_TCM_TCPDIRECT
...
class CTORATstpSecurityField(object):
	...
	# 是否可当日回转交易
    DayTrading = property(_traderapi.CTORATstpSecurityField_DayTrading_get, _traderapi.CTORATstpSecurityField_DayTrading_set)
...
class CTORATstpPositionField(object):
	...
	# 当日累计平仓数量
    TodayTotalCloseVolume = property(_traderapi.CTORATstpPositionField_TodayTotalCloseVolume_get, _traderapi.CTORATstpPositionField_TodayTotalCloseVolume_set)
...
class CTORATstpETFFileField(object):
    ...
    def dict(self,):#解读内存当中的数据
        return {
            "交易日":self.TradingDay,

            "交易所代码":self.ExchangeID,

            "ETF交易代码":self.ETFSecurityID,

            "ETF申赎代码":self.ETFCreRedSecurityID,

            "最小申购赎回单位份数":self.CreationRedemptionUnit,

            "最大现金替代比例":self.Maxcashratio,

            "预估现金差额":self.EstimateCashComponent,

            "前一交易日现金差额":self.CashComponent,

            "前一交易日基金单位净值":self.NAV,

            "前一交易日申赎基准单位净值":self.NAVperCU,

            "当日申购赎回基准单位的红利金额":self.DividendPerCU,

            "ETF申赎类型":self.ETFCreRedType,

            "ETF证券名称":self.ETFSecurityName,
        }
...
class CTORATstpETFBasketField(object):
    ...
    def dict(self):
        return {
            ...
            "ETF成份证券代码":self.SecurityID ,

            "成分证券名称":self.SecurityName ,

            "成分证券数量":self.Volume ,

            "现金替代标志":self.ETFCurrenceReplaceStatus ,

            "溢价比例":self.Premium ,

            "申购替代金额":self.CreationReplaceAmount ,

            "赎回替代金额":self.RedemptionReplaceAmount ,
...
#########################################查询国际市场互联状态信息############################################
class CTORATstpQryImcParamsField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 市场代码
    MarketID = property(_traderapi.CTORATstpQryImcParamsField_MarketID_get, _traderapi.CTORATstpQryImcParamsField_MarketID_set)

    def __init__(self):
        _traderapi.CTORATstpQryImcParamsField_swiginit(self, _traderapi.new_CTORATstpQryImcParamsField())
    __swig_destroy__ = _traderapi.delete_CTORATstpQryImcParamsField

# Register CTORATstpQryImcParamsField in _traderapi:
_traderapi.CTORATstpQryImcParamsField_swigregister(CTORATstpQryImcParamsField)
...
class CTORATstpImcParamsField(object):
	...
	# 市场代码
    MarketID = property(_traderapi.CTORATstpImcParamsField_MarketID_get, _traderapi.CTORATstpImcParamsField_MarketID_set)

	# 是否开放
    OpenFlag = property(_traderapi.CTORATstpImcParamsField_OpenFlag_get, _traderapi.CTORATstpImcParamsField_OpenFlag_set)

	# 初始额度
    ThresholdAmount = property(_traderapi.CTORATstpImcParamsField_ThresholdAmount_get, _traderapi.CTORATstpImcParamsField_ThresholdAmount_set)

	# 日中剩余额度
    PosAmt = property(_traderapi.CTORATstpImcParamsField_PosAmt_get, _traderapi.CTORATstpImcParamsField_PosAmt_set)

	# 额度是否可用
    AmountStatus = property(_traderapi.CTORATstpImcParamsField_AmountStatus_get, _traderapi.CTORATstpImcParamsField_AmountStatus_set)

    def __init__(self):
        _traderapi.CTORATstpImcParamsField_swiginit(self, _traderapi.new_CTORATstpImcParamsField())
    __swig_destroy__ = _traderapi.delete_CTORATstpImcParamsField

# Register CTORATstpImcParamsField in _traderapi:
_traderapi.CTORATstpImcParamsField_swigregister(CTORATstpImcParamsField)




#########################################查询国际市场互联汇率信息############################################
class CTORATstpQryImcExchangeRateField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 源货币币种
    FromCurrency = property(_traderapi.CTORATstpQryImcExchangeRateField_FromCurrency_get, _traderapi.CTORATstpQryImcExchangeRateField_FromCurrency_set)

	# 目标货币币种
    ToCurrency = property(_traderapi.CTORATstpQryImcExchangeRateField_ToCurrency_get, _traderapi.CTORATstpQryImcExchangeRateField_ToCurrency_set)

	# 市场代码
    MarketID = property(_traderapi.CTORATstpQryImcExchangeRateField_MarketID_get, _traderapi.CTORATstpQryImcExchangeRateField_MarketID_set)

    def __init__(self):
        _traderapi.CTORATstpQryImcExchangeRateField_swiginit(self, _traderapi.new_CTORATstpQryImcExchangeRateField())
    __swig_destroy__ = _traderapi.delete_CTORATstpQryImcExchangeRateField

# Register CTORATstpQryImcExchangeRateField in _traderapi:
_traderapi.CTORATstpQryImcExchangeRateField_swigregister(CTORATstpQryImcExchangeRateField)




#########################################国际市场互联汇率信息############################################
class CTORATstpImcExchangeRateField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 源货币币种
    FromCurrency = property(_traderapi.CTORATstpImcExchangeRateField_FromCurrency_get, _traderapi.CTORATstpImcExchangeRateField_FromCurrency_set)

	# 目标货币币种
    ToCurrency = property(_traderapi.CTORATstpImcExchangeRateField_ToCurrency_get, _traderapi.CTORATstpImcExchangeRateField_ToCurrency_set)

	# 参考汇率买入价
    BidRate = property(_traderapi.CTORATstpImcExchangeRateField_BidRate_get, _traderapi.CTORATstpImcExchangeRateField_BidRate_set)

	# 参考汇率卖出价
    OfferRate = property(_traderapi.CTORATstpImcExchangeRateField_OfferRate_get, _traderapi.CTORATstpImcExchangeRateField_OfferRate_set)

	# 参考汇率中间价
    MidPointRate = property(_traderapi.CTORATstpImcExchangeRateField_MidPointRate_get, _traderapi.CTORATstpImcExchangeRateField_MidPointRate_set)

	# 市场代码
    MarketID = property(_traderapi.CTORATstpImcExchangeRateField_MarketID_get, _traderapi.CTORATstpImcExchangeRateField_MarketID_set)

    def __init__(self):
        _traderapi.CTORATstpImcExchangeRateField_swiginit(self, _traderapi.new_CTORATstpImcExchangeRateField())
    __swig_destroy__ = _traderapi.delete_CTORATstpImcExchangeRateField

# Register CTORATstpImcExchangeRateField in _traderapi:
_traderapi.CTORATstpImcExchangeRateField_swigregister(CTORATstpImcExchangeRateField)




#########################################查询最小价差信息############################################
class CTORATstpQryHKPriceTickInfoField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 价差品种
    PriceTickID = property(_traderapi.CTORATstpQryHKPriceTickInfoField_PriceTickID_get, _traderapi.CTORATstpQryHKPriceTickInfoField_PriceTickID_set)

	# 市场代码
    MarketID = property(_traderapi.CTORATstpQryHKPriceTickInfoField_MarketID_get, _traderapi.CTORATstpQryHKPriceTickInfoField_MarketID_set)

    def __init__(self):
        _traderapi.CTORATstpQryHKPriceTickInfoField_swiginit(self, _traderapi.new_CTORATstpQryHKPriceTickInfoField())
    __swig_destroy__ = _traderapi.delete_CTORATstpQryHKPriceTickInfoField

# Register CTORATstpQryHKPriceTickInfoField in _traderapi:
_traderapi.CTORATstpQryHKPriceTickInfoField_swigregister(CTORATstpQryHKPriceTickInfoField)




#########################################最小价差信息############################################
class CTORATstpHKPriceTickInfoField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 价差品种
    PriceTickID = property(_traderapi.CTORATstpHKPriceTickInfoField_PriceTickID_get, _traderapi.CTORATstpHKPriceTickInfoField_PriceTickID_set)

	# 价差组号
    PriceTickGroupID = property(_traderapi.CTORATstpHKPriceTickInfoField_PriceTickGroupID_get, _traderapi.CTORATstpHKPriceTickInfoField_PriceTickGroupID_set)

	# 价差类别
    PriceTickType = property(_traderapi.CTORATstpHKPriceTickInfoField_PriceTickType_get, _traderapi.CTORATstpHKPriceTickInfoField_PriceTickType_set)

	# 价差组起始价格
    BeginPrice = property(_traderapi.CTORATstpHKPriceTickInfoField_BeginPrice_get, _traderapi.CTORATstpHKPriceTickInfoField_BeginPrice_set)

	# 价差组结束价格
    EndPrice = property(_traderapi.CTORATstpHKPriceTickInfoField_EndPrice_get, _traderapi.CTORATstpHKPriceTickInfoField_EndPrice_set)

	# 价差值
    PriceTick = property(_traderapi.CTORATstpHKPriceTickInfoField_PriceTick_get, _traderapi.CTORATstpHKPriceTickInfoField_PriceTick_set)

	# 市场代码
    MarketID = property(_traderapi.CTORATstpHKPriceTickInfoField_MarketID_get, _traderapi.CTORATstpHKPriceTickInfoField_MarketID_set)

    def __init__(self):
        _traderapi.CTORATstpHKPriceTickInfoField_swiginit(self, _traderapi.new_CTORATstpHKPriceTickInfoField())
    __swig_destroy__ = _traderapi.delete_CTORATstpHKPriceTickInfoField

# Register CTORATstpHKPriceTickInfoField in _traderapi:
_traderapi.CTORATstpHKPriceTickInfoField_swigregister(CTORATstpHKPriceTickInfoField)
...
#########################################查询公募基金发行信息############################################
class CTORATstpQryPublicOfferedFundInfoField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 交易所代码
    ExchangeID = property(_traderapi.CTORATstpQryPublicOfferedFundInfoField_ExchangeID_get, _traderapi.CTORATstpQryPublicOfferedFundInfoField_ExchangeID_set)

	# 基金代码
    SecurityID = property(_traderapi.CTORATstpQryPublicOfferedFundInfoField_SecurityID_get, _traderapi.CTORATstpQryPublicOfferedFundInfoField_SecurityID_set)

	# 基金管理人代码
    ManagerID = property(_traderapi.CTORATstpQryPublicOfferedFundInfoField_ManagerID_get, _traderapi.CTORATstpQryPublicOfferedFundInfoField_ManagerID_set)

    def __init__(self):
        _traderapi.CTORATstpQryPublicOfferedFundInfoField_swiginit(self, _traderapi.new_CTORATstpQryPublicOfferedFundInfoField())
    __swig_destroy__ = _traderapi.delete_CTORATstpQryPublicOfferedFundInfoField

# Register CTORATstpQryPublicOfferedFundInfoField in _traderapi:
_traderapi.CTORATstpQryPublicOfferedFundInfoField_swigregister(CTORATstpQryPublicOfferedFundInfoField)




#########################################公募基金发行信息############################################
class CTORATstpPublicOfferedFundInfoField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 交易所代码
    ExchangeID = property(_traderapi.CTORATstpPublicOfferedFundInfoField_ExchangeID_get, _traderapi.CTORATstpPublicOfferedFundInfoField_ExchangeID_set)

	# 基金代码
    SecurityID = property(_traderapi.CTORATstpPublicOfferedFundInfoField_SecurityID_get, _traderapi.CTORATstpPublicOfferedFundInfoField_SecurityID_set)

	# 基金管理人代码
    ManagerID = property(_traderapi.CTORATstpPublicOfferedFundInfoField_ManagerID_get, _traderapi.CTORATstpPublicOfferedFundInfoField_ManagerID_set)

	# 转发回报交易单元
    ForwardPbuID = property(_traderapi.CTORATstpPublicOfferedFundInfoField_ForwardPbuID_get, _traderapi.CTORATstpPublicOfferedFundInfoField_ForwardPbuID_set)

	# 转发回报股东账号
    ForwardShareholderID = property(_traderapi.CTORATstpPublicOfferedFundInfoField_ForwardShareholderID_get, _traderapi.CTORATstpPublicOfferedFundInfoField_ForwardShareholderID_set)

    def __init__(self):
        _traderapi.CTORATstpPublicOfferedFundInfoField_swiginit(self, _traderapi.new_CTORATstpPublicOfferedFundInfoField())
    __swig_destroy__ = _traderapi.delete_CTORATstpPublicOfferedFundInfoField

# Register CTORATstpPublicOfferedFundInfoField in _traderapi:
_traderapi.CTORATstpPublicOfferedFundInfoField_swigregister(CTORATstpPublicOfferedFundInfoField)




#########################################查询公募基金申赎成交明细############################################
class CTORATstpQryPublicOfferedFundTradeDetailField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 交易所代码
    ExchangeID = property(_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_ExchangeID_get, _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_ExchangeID_set)

	# 基金代码
    FundSecurityID = property(_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_FundSecurityID_get, _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_FundSecurityID_set)

	# 基金管理人代码
    ManagerID = property(_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_ManagerID_get, _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_ManagerID_set)

	# 起始索引序号
    IndexStart = property(_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_IndexStart_get, _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_IndexStart_set)

	# 结束索引序号
    IndexEnd = property(_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_IndexEnd_get, _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_IndexEnd_set)

    def __init__(self):
        _traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_swiginit(self, _traderapi.new_CTORATstpQryPublicOfferedFundTradeDetailField())
    __swig_destroy__ = _traderapi.delete_CTORATstpQryPublicOfferedFundTradeDetailField

# Register CTORATstpQryPublicOfferedFundTradeDetailField in _traderapi:
_traderapi.CTORATstpQryPublicOfferedFundTradeDetailField_swigregister(CTORATstpQryPublicOfferedFundTradeDetailField)




#########################################公募基金申赎成交明细############################################
class CTORATstpPublicOfferedFundTradeDetailField(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

	# 交易所代码
    ExchangeID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ExchangeID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ExchangeID_set)

	# 股东账户代码
    ShareholderID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ShareholderID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ShareholderID_set)

	# 申赎方向
    Direction = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_Direction_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_Direction_set)

	# 基金代码
    FundSecurityID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_FundSecurityID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_FundSecurityID_set)

	# 成分股代码
    BasketSecurityID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_BasketSecurityID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_BasketSecurityID_set)

	# 成交回报类型
    TradeReportType = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeReportType_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeReportType_set)

	# 成交编号
    TradeID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeID_set)

	# 交易单元代码
    PbuID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_PbuID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_PbuID_set)

	# 本地报单编号
    OrderLocalID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_OrderLocalID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_OrderLocalID_set)

	# 交易所订单编号
    ExchOrderID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ExchOrderID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ExchOrderID_set)

	# 成交明细记录数
    TradeReportNums = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeReportNums_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeReportNums_set)

	# 成分股交付数量
    DeliveryVolume = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_DeliveryVolume_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_DeliveryVolume_set)

	# 总现金替代金额
    TotalSubsCash = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TotalSubsCash_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TotalSubsCash_set)

	# 沪市替代金额(仅沪市基金有效)
    SSESubsCash = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_SSESubsCash_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_SSESubsCash_set)

	# 深市替代金额(仅沪市基金有效)
    SZSESubsCash = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_SZSESubsCash_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_SZSESubsCash_set)

	# 港市替代金额(仅沪市基金有效)
    HKSubsCash = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_HKSubsCash_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_HKSubsCash_set)

	# 其它替代金额(仅沪市基金有效)
    OtherSubsCash = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_OtherSubsCash_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_OtherSubsCash_set)

	# 成交日期
    TradeDate = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeDate_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeDate_set)

	# 成交时间
    TradeTime = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeTime_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_TradeTime_set)

	# 基金管理人代码
    ManagerID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerID_set)

	# 基金管理人交易单元
    ManagerPbuID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerPbuID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerPbuID_set)

	# 基金管理人股东账号
    ManagerShareholderID = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerShareholderID_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_ManagerShareholderID_set)

	# 数据索引
    DataIndex = property(_traderapi.CTORATstpPublicOfferedFundTradeDetailField_DataIndex_get, _traderapi.CTORATstpPublicOfferedFundTradeDetailField_DataIndex_set)

    def __init__(self):
        _traderapi.CTORATstpPublicOfferedFundTradeDetailField_swiginit(self, _traderapi.new_CTORATstpPublicOfferedFundTradeDetailField())
    __swig_destroy__ = _traderapi.delete_CTORATstpPublicOfferedFundTradeDetailField

# Register CTORATstpPublicOfferedFundTradeDetailField in _traderapi:
_traderapi.CTORATstpPublicOfferedFundTradeDetailField_swigregister(CTORATstpPublicOfferedFundTradeDetailField)
...
class CTORATstpTraderSpi(object):
	...
	#公募基金管理人调仓报单响应,参数pInputOrderField是一个CTORATstpInputOrderField类对象
    def OnRspPublicOfferedFundOrderInsert(self, pInputOrderField: "CTORATstpInputOrderField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspPublicOfferedFundOrderInsert(self, pInputOrderField, pRspInfoField, nRequestID)
	...
	#查询国际市场互联状态信息响应,参数pImcParamsField是一个CTORATstpImcParamsField类对象
    def OnRspQryImcParams(self, pImcParamsField: "CTORATstpImcParamsField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int", bIsLast: "bool") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspQryImcParams(self, pImcParamsField, pRspInfoField, nRequestID, bIsLast)

	#查询国际市场互联汇率信息响应,参数pImcExchangeRateField是一个CTORATstpImcExchangeRateField类对象
    def OnRspQryImcExchangeRate(self, pImcExchangeRateField: "CTORATstpImcExchangeRateField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int", bIsLast: "bool") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspQryImcExchangeRate(self, pImcExchangeRateField, pRspInfoField, nRequestID, bIsLast)

	#查询最小价差信息响应,参数pHKPriceTickInfoField是一个CTORATstpHKPriceTickInfoField类对象
    def OnRspQryHKPriceTickInfo(self, pHKPriceTickInfoField: "CTORATstpHKPriceTickInfoField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int", bIsLast: "bool") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspQryHKPriceTickInfo(self, pHKPriceTickInfoField, pRspInfoField, nRequestID, bIsLast)
	...
	#查询公募基金发行信息响应,参数pPublicOfferedFundInfoField是一个CTORATstpPublicOfferedFundInfoField类对象
    def OnRspQryPublicOfferedFundInfo(self, pPublicOfferedFundInfoField: "CTORATstpPublicOfferedFundInfoField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int", bIsLast: "bool") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspQryPublicOfferedFundInfo(self, pPublicOfferedFundInfoField, pRspInfoField, nRequestID, bIsLast)

	#查询公募基金申赎成交明细响应,参数pPublicOfferedFundTradeDetailField是一个CTORATstpPublicOfferedFundTradeDetailField类对象
    def OnRspQryPublicOfferedFundTradeDetail(self, pPublicOfferedFundTradeDetailField: "CTORATstpPublicOfferedFundTradeDetailField", pRspInfoField: "CTORATstpRspInfoField", nRequestID: "int", bIsLast: "bool") -> "void":
        return _traderapi.CTORATstpTraderSpi_OnRspQryPublicOfferedFundTradeDetail(self, pPublicOfferedFundTradeDetailField, pRspInfoField, nRequestID, bIsLast)
...
class CTORATstpTraderApi(object):
	...
	#公募基金管理人调仓报单请求,参数pInputOrderField是一个CTORATstpInputOrderField类对象
    def ReqPublicOfferedFundOrderInsert(self, pInputOrderField: "CTORATstpInputOrderField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqPublicOfferedFundOrderInsert(self, pInputOrderField, nRequestID)
	...
	#查询国际市场互联状态信息请求,参数pQryImcParamsField是一个CTORATstpQryImcParamsField类对象
    def ReqQryImcParams(self, pQryImcParamsField: "CTORATstpQryImcParamsField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqQryImcParams(self, pQryImcParamsField, nRequestID)

	#查询国际市场互联汇率信息请求,参数pQryImcExchangeRateField是一个CTORATstpQryImcExchangeRateField类对象
    def ReqQryImcExchangeRate(self, pQryImcExchangeRateField: "CTORATstpQryImcExchangeRateField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqQryImcExchangeRate(self, pQryImcExchangeRateField, nRequestID)

	#查询最小价差信息请求,参数pQryHKPriceTickInfoField是一个CTORATstpQryHKPriceTickInfoField类对象
    def ReqQryHKPriceTickInfo(self, pQryHKPriceTickInfoField: "CTORATstpQryHKPriceTickInfoField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqQryHKPriceTickInfo(self, pQryHKPriceTickInfoField, nRequestID)
	...
	#查询公募基金发行信息请求,参数pQryPublicOfferedFundInfoField是一个CTORATstpQryPublicOfferedFundInfoField类对象
    def ReqQryPublicOfferedFundInfo(self, pQryPublicOfferedFundInfoField: "CTORATstpQryPublicOfferedFundInfoField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqQryPublicOfferedFundInfo(self, pQryPublicOfferedFundInfoField, nRequestID)

	#查询公募基金申赎成交明细请求,参数pQryPublicOfferedFundTradeDetailField是一个CTORATstpQryPublicOfferedFundTradeDetailField类对象
    def ReqQryPublicOfferedFundTradeDetail(self, pQryPublicOfferedFundTradeDetailField: "CTORATstpQryPublicOfferedFundTradeDetailField", nRequestID: "int") -> "int":
        return _traderapi.CTORATstpTraderApi_ReqQryPublicOfferedFundTradeDetail(self, pQryPublicOfferedFundTradeDetailField, nRequestID)
